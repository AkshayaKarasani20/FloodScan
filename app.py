...
with st.sidebar:
    ...
    with st.expander("About FloodScan"):

        st.write(
            "FloodScan is an AI-powered flood detection "
...
if st.session_state.result is None:
    ...
    with center:
        ...
        st.write(
            "Upload a satellite image and let FloodScan "
...
if uploaded_file is not None and analyze:
    ...
    with st.spinner(
        "FloodScan is analyzing the satellite image..."
    ):
...
"""
    ...
    st.download_button(
        ...
        data=report,
        file_name="FloodScan_Report.txt",
        mime="text/plain"
    )